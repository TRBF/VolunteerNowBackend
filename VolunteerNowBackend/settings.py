"""
Django settings for VolunteerNowBackend project.
...
SECRET_KEY = 'django-insecure-03cw=9va^zq-x1kif=zvl41zm9y$!p_4=vkua7)$9305so@$q6'
...
ROOT_URLCONF = 'VolunteerNowBackend.urls'
TEMPLATES = [
    {
...
STATIC_URL = 'static/'
MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), 'VolunteerNowBackend/mediafiles')
MEDIA_URL = '/media/'
