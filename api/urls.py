...
urlpatterns = [
    ...
    path('get_volunteer_notifications/<int:volunteer_id>', views.get_volunteer_notifications),
    path('get_volunteer_experiences/<int:volunteer_id>', views.get_volunteer_experiences),
